...
**Passing implementation workflow:** [CI run 30786576709](https://github.com/Lukeyone/geoprospect/actions/runs/30786576709)
...
- Added `SpatialLayout` to reconcile cross-object cell, block and positive-site assignments.
...
- Required resolved qualitative gates to contain measured evidence.
- Prevented unresolved duplicate risk from entering the high-confidence positive count.
- Required block-level positive-site assignments to reconcile exactly with member cells.
